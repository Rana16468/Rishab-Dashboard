  ...
  return (
    <div className="min-h-screen bg-transparent p-6 space-y-8">
      ...
      <div className="space-y-6">
        {/* Header */}
        <div className="bg-linear-to-r from-[#2E6F65] to-[#58976B] rounded-t-xl p-6 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <Table>
              <TableHeader className="bg-white">
                <TableRow className="border-b border-gray-100 hover:bg-transparent">
                  ...
                  <TableHead
                    className={`font-semibold text-base py-5 ${textPrimary} text-center`}
                  >
                    Action
                  </TableHead>
                </TableRow>
              ...
              <TableBody>
                {earningsData.map((item, i) => (
                  ...
                  >
                    ...
                    <TableCell
                      className={`font-medium py-4 ${item.isHighPrice ? "text-[#58976B]" : "text-[#58976B]"}`}
                    >
                      {item.price}
                    </TableCell>
                    <TableCell className="text-gray-600 py-4">
                    ...
                    <TableCell className="py-4">
                      <div className="flex items-center justify-center gap-3">
                        ...
                        <button
                          className={`p-2 hover:bg-green-50 rounded-full transition-colors ${textPrimary}`}
                        >
