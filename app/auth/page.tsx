...
function SignInPage() {
  ...
  // Update localStorage when email or password changes and checkbox is checked
  useEffect(() => {
      ...
      <div className="container mx-auto">
        <div className="flex  justify-center items-center">
          <div className="w-full lg:w-1/2 bg-white p-5 md:px-18 md:py-28 shadow-[0px_10px_30px_rgba(0,0,0,0.1)] rounded-2xl">
            <div className="flex justify-center items-center">
              <h2 className="text-3xl font-bold text-[#0D0D0D] mb-5">AMI</h2>
            </div>
